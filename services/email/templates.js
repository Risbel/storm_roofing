export const SERVICE_CONTENT_TEMPLATE = `
    ...
    <style type="text/css">
      ...
      * {
      ...
      @media (max-width: 480px) {
        ...
        #u_content_social_4 .v-container-padding-padding {
          padding: 30px 10px 10px !important;
        }
                            ...
                            <tr>
                              ...
                              >
                                <h1
                                  ...
                                  "
                                >
                                  <strong>Service Request: {{service}}</strong>
                                </h1>
                              </td>
                            </tr>
                          </tbody>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <table
                          id="u_content_text_deprecated_7"
                          style="font-family: 'Open Sans', sans-serif"
                          role="presentation"
                          cellpadding="0"
                          cellspacing="0"
                        ...
                        <table
                          id="u_content_text_deprecated_8"
                          style="font-family: 'Open Sans', sans-serif"
                          role="presentation"
                          cellpadding="0"
                          cellspacing="0"
